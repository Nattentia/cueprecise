...
### 같은 근거로 만든 한국어 자막으로 봅니다

자동 번역이 부정확한 외국어 강연에 한국어 자막을 얹어 볼 수 있습니다. 자막을 새로
만드는 것이 아니라 이미 분석해 둔 근거를 그대로 씁니다.

먼저 전문용어를 확정합니다. Gemini 전사를 YouTube 자막·화면에 뜬 글자와 대조해
...
- [ ] 외부 재생이 막힌 영상을 위한 브라우저 확장 프로그램 (YouTube 페이지 위에 자막을 얹는다)
- [ ] 한국어 외 언어 자막
- [ ] 호스트별 타임스탬프 링크 통일
- [ ] 청크 전사 파이프라이닝
- [ ] 여러 영상 통합 분석
