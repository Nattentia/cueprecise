...
> **1시간이 넘는 YouTube 영상을 3분 만에 분석하고, 필요한 말과 화면이 나온 순간을 근거와 함께 찾아줍니다.**
...
- 자막에서 복원한 표현의 시각은 자막과 전사 사이의 빈 구간 안에 균등 배치한
  근사치입니다. 원본 자막의 정확한 발화 시각을 뜻하지는 않습니다.
- 다국어 검색은 번역·임베딩이 아닌 어휘 검색입니다. 호스트 AI가 질문을 원어 검색어로
  바꾸지 않으면 원래 표현이 필요할 수 있습니다.
