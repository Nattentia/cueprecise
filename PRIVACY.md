...
- Gemini API 키는 연결한 AI 앱이 CuePrecise를 실행할 수 있도록 그 앱의 로컬 설정
  파일에 평문으로 저장된다. 저장소나 프로젝트 운영자에게 전송되지 않는다.
...
컴퓨터 또는 AI 앱 설정에 접근할 수 있는 다른 사람이나 프로그램은 저장된 API 키를 읽을
수 있다. 공용 컴퓨터에서는 사용하지 않는다.
